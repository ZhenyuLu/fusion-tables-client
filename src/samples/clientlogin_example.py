...
if __name__ == "__main__":
    ...
    import sys, getpass
    #username = sys.argv[1]
    username = "luzhenyu1981@gmail.com"
    ...
    jk = ft_client.query(SQL().createTable(table)).split("\n")
    ...
    rowid = ft_client.query(SQL().insert(tableid, {'strings':'mystring', 'numbers': 12, 'locations':'Palo Alto, CA'})).split("\n")[1]
    print rowid
    ...
    tableid = CSVImporter(ft_client).importFile("data.csv")
    print tableid
